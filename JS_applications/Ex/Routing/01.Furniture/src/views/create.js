      ...
      <div class="row space-top">
        <div class="col-md-4">
          <div class="form-group">
            ...
            <input
              class=${"form-control" + (invalidMake ? " is-invalid" : "")}
              id="new-make"
              type="text"
              name="make"
            />
          ...
          <div class="form-group has-success">
            ...
            <input
              class=${"form-control" + (invalidModel ? " is-invalid" : "")}
              type="text"
              name="model"
            />
          </div>
          <div class="form-group has-danger">
            ...
            <input
              class=${"form-control" + (invalidYear ? " is-invalid" : "")}
              id="new-year"
              type="number"
              name="year"
            />
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <input
              class=${"form-control" + (invalidPrice ? " is-invalid" : "")}
              id="new-price"
              type="number"
              name="price"
            />
          ...
          <div class="form-group">
            ...
            <input
              class=${"form-control" + (invalidImg ? " is-invalid" : "")}
              id="new-image"
              type="text"
              name="img"
            />
